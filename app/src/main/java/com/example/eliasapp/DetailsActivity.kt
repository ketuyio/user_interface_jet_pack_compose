...
import com.example.eliasapp.ui.theme.Trait
...
fun firebaseUI(context: Context, patientList: SnapshotStateList<patients?>) {
    Column(modifier = Modifier
        ...
        TopAppBar(
            ...
            colors = TopAppBarDefaults.mediumTopAppBarColors(Trait),
            navigationIcon = {
                ...
                Card(
                    ...
                    Column(modifier = Modifier
                        ...
                        Row {
                            ...
                            patientList[index]?.courseName?.let {
                                Text(
                                    text = it,
                        ...
                        Row {
                            ...
                            patientList[index]?.courseDuration?.let {
                                Text(
                                    text = it,
                                    modifier = Modifier.padding(4.dp),
                                    color = Color.Black,
                        ...
                        Row {
                            ...
                            patientList[index]?.courseDescription?.let {
                                Text(
                                    text = it,
                                    modifier = Modifier.padding(4.dp),
                                    color = Color.Black,
